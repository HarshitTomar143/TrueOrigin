           ...
           <Header/>
            ...
            <main className="flex-grow flex items-center justify-center p-4">
                <div className="text-center bg-white p-8 rounded-lg shadow-md">
                    <h1 className="text-4xl font-bold text-[#3A5B22] mb-4">Our Team</h1>
                    <p className="text-lg text-gray-700 max-w-2xl mx-auto">
                        Meet the dedicated team behind TrueOrigin. We are a diverse group of experts
                        committed to bringing transparency and trust to every product.
                    </p>
                </div>
            </main>
