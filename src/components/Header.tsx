    ...
    <header className="flex items-center justify-between mx-[10px] p-4 relative backdrop-blur-xl bg-white/10 border-b border-white/20 shadow-lg z-30 m-4 border-2 rounded-xl min-h-[72px]">
      ...
      <div className="hidden md:flex items-center bg-white/10 backdrop-blur-xl border border-white/20 shadow-md rounded-lg py-2 px-6 space-x-6 relative z-20 min-w-[500px] justify-center">
        <nav className="flex space-x-6 flex-nowrap items-center">
          ...
          <Link href="/home/workshop" className={`flex items-center h-10 px-4 text-white hover:text-black font-medium transition-transform transform ${pathname === '/home/workshop' ? "scale-105 text-[#b993f4] border-b-2 border-[#4e3278]" : ""}`}>Workshop</Link>
          ...
          <Link href="/home/truemap" className={`flex items-center h-10 px-4 text-white hover:text-black font-medium transition-transform transform ${pathname === '/home/truemap' ? "scale-105 text-[#b993f4] border-b-2 border-[#3d2266]" : ""}`}>TrueMap</Link>
