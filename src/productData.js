// data/productData.js
const productData = {
  // ... (your entire productData object from the context)
  madhubanipaintings: {
  ...
  nagpuroranges: {
    ...
    culturalSignificance: "Nagpur Oranges are a popular variety from Maharashtra, known for their sweet and juicy taste. They are a symbol of the region's rich agricultural heritage and is often enjoyed during the orange season.",
